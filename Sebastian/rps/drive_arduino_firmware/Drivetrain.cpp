...
void Drivetrain::setForward(int forward)
{ 
	this->forward.target = forward;
}

void Drivetrain::setRight(int right)
{ 
	this->right.target = right;
}

void Drivetrain::setClockwise(int clockwise)
{ 
	this->clockwise.target = clockwise;
}

// Set configurations
void Drivetrain::setRampFactor(int ramp)
{
	ramp_factor = ramp;
}

void Drivetrain::setMaxFreq(int max)
{ 
	max_freq = max;
}
